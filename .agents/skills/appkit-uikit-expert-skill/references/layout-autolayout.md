...
Use this reference for UI layout or visual styling work on UIKit or AppKit.
...
## Liquid Glass
- Follow `liquid-glass-design.md` for Liquid Glass behavior and APIs on UIKit/AppKit.
